...
class report_ks_account_general_ledger(models.AbstractModel):
    _name = "account.ks.general.ledger"
    ...
    def _get_templates(self):
        templates = super(report_ks_account_general_ledger, self)._get_templates()
